  ...
  return (
    <div className={styles.sectionWorks}>
      ...
      <div className={styles['contents']}>
        <div className={classNames(styles['wrapper'], { [styles.focus]: activeMenu === 'work' })}>
          {workData && <SliderSp id='works' data={workData} />}
        </div>

        <div className={classNames(styles['wrapper'], { [styles.focus]: activeMenu === 'music' })}>
          {musicData && <SliderSp id='musics' data={musicData} />}
        </div>

        <div className={classNames(styles['wrapper'], { [styles.focus]: activeMenu === 'photo' })}>
          <p>Coming soon・・・</p>
        </div>
      </div>
    </div>
